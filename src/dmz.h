 ...
 */
#define DMZ_MAGIC ((((unsigned int)('D')) << 24) | (((unsigned int)('Z')) << 16) | (((unsigned int)('B')) << 8) | ((unsigned int)('D')))
...
#define DMZ_MSET_VALID (DMZ_MSET_SB_VALID | DMZ_MSET_MAP_VALID | DMZ_MSET_BITMAP_VALID)
...
extern struct dmz_block_dev *dmz_block_to_bdev(struct dmz_dev *dev, __u64 block, __u64 *ret_block);
extern struct dmz_block_dev *dmz_sector_to_bdev(struct dmz_dev *dev, __u64 sector, __u64 *ret_sector);
